...
//	--token        JWT bearer token (env: INVENTORY_SERVICE_TOKEN)
...
var componentDeleteCmd = &cobra.Command{
	Use:   "delete [uid...]",
	Short: "Delete one or more Component resources",
	Long: `Deletes one or more Component resources.
...
Each UID is processed one by one as an individual, atomic delete operation. If any deletion fails, the command will still attempt to delete the remaining UIDs and report the errors at the end.`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		for _, uid := range args {
			if err := c.DeleteComponent(ctx, uid); err != nil {
				errs = append(errs, fmt.Errorf("failed to delete Component %q: %w", uid, err))
				continue
			}
...
var componentendpointDeleteCmd = &cobra.Command{
	Use:   "delete [uid...]",
	Short: "Delete one or more ComponentEndpoint resources",
	Long: `Deletes one or more ComponentEndpoint resources.
...
Each UID is processed one by one as an individual, atomic delete operation. If any deletion fails, the command will still attempt to delete the remaining UIDs and report the errors at the end.`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		var errs []error
		for _, uid := range args {
			if err := c.DeleteComponentEndpoint(ctx, uid); err != nil {
				errs = append(errs, fmt.Errorf("failed to delete ComponentEndpoint %q: %w", uid, err))
				continue
			}
...
var ethernetinterfaceDeleteCmd = &cobra.Command{
	Use:   "delete [uid...]",
	Short: "Delete one or more EthernetInterface resources",
	Long: `Deletes one or more EthernetInterface resources.
...
Each UID is processed one by one as an individual, atomic delete operation. If any deletion fails, the command will still attempt to delete the remaining UIDs and report the errors at the end.`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		var errs []error
		for _, uid := range args {
			if err := c.DeleteEthernetInterface(ctx, uid); err != nil {
				errs = append(errs, fmt.Errorf("failed to delete EthernetInterface %q: %w", uid, err))
				continue
			}
...
var hardwareDeleteCmd = &cobra.Command{
	Use:   "delete [uid...]",
	Short: "Delete one or more Hardware resources",
	Long: `Deletes one or more Hardware resources.
...
Each UID is processed one by one as an individual, atomic delete operation. If any deletion fails, the command will still attempt to delete the remaining UIDs and report the errors at the end.`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		var errs []error
		for _, uid := range args {
			if err := c.DeleteHardware(ctx, uid); err != nil {
				errs = append(errs, fmt.Errorf("failed to delete Hardware %q: %w", uid, err))
				continue
			}
...
var redfishendpointDeleteCmd = &cobra.Command{
	Use:   "delete [uid...]",
	Short: "Delete one or more RedfishEndpoint resources",
	Long: `Deletes one or more RedfishEndpoint resources.
...
Each UID is processed one by one as an individual, atomic delete operation. If any deletion fails, the command will still attempt to delete the remaining UIDs and report the errors at the end.`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		var errs []error
		for _, uid := range args {
			if err := c.DeleteRedfishEndpoint(ctx, uid); err != nil {
				errs = append(errs, fmt.Errorf("failed to delete RedfishEndpoint %q: %w", uid, err))
				continue
			}
...
var serviceendpointDeleteCmd = &cobra.Command{
	Use:   "delete [uid...]",
	Short: "Delete one or more ServiceEndpoint resources",
	Long: `Deletes one or more ServiceEndpoint resources.
...
Each UID is processed one by one as an individual, atomic delete operation. If any deletion fails, the command will still attempt to delete the remaining UIDs and report the errors at the end.`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		var errs []error
		for _, uid := range args {
			if err := c.DeleteServiceEndpoint(ctx, uid); err != nil {
				errs = append(errs, fmt.Errorf("failed to delete ServiceEndpoint %q: %w", uid, err))
				continue
			}
