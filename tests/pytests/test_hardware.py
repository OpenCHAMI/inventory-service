...
def test_hardware(discover_hardware):
    # Step 1: GET existing hardware to use as a template, or create a simple one
    ...
    # Step 3: GET the newly created hardware and verify it exists
    ...
    # Step 5: PUT the modified hardware
    ...
    # Step 8: GET again to verify the hardware is gone
    response = requests.get(f"{inventory_base_url}/v2/Inventory/Hardware/{new_id}")
